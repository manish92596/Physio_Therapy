...
const WaveformAnimation = () => {
  ...
  return (
    <div className="flex items-end justify-center gap-0.5 sm:gap-1 md:gap-1.5 h-40 md:h-56">
      {[...Array(bars)].map((_, i) => (
        <motion.div
          key={i}
          className="w-1 sm:w-1.5 md:w-2.5 rounded-full"
          style={{
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="bg-white rounded-3xl p-4 sm:p-8 md:p-12 shadow-[0_4px_24px_rgba(18,28,26,0.06)] border border-charcoal/5">
              {/* Phone mockup header */}
            ...
            <motion.div
              ...
              className="absolute -top-4 -right-2 sm:-right-4 bg-teal text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-medium shadow-lg z-10"
            >
              24/7 Active
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute -bottom-4 -left-2 sm:-left-4 bg-terracotta-light text-charcoal px-3 py-1.5 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-medium shadow-lg z-10"
            >
              98% Satisfaction
            </motion.div>
          </motion.div>
